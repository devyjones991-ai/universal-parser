...
class CacheOptimizer:
    ...
    async def set(
        ...
        try:
            ...
            logger.error("Error setting cache: {e}")
            self.cache_stats["errors"] += 1
            return False
    ...
    async def delete(self, key: str) -> bool:
        ...
        try:
            ...
            logger.error("Error deleting from cache: {e}")
            return False
    ...
    async def _store_in_memory(self, key: str, value: Any, config: CacheConfig)  # noqa  # noqa: E501 E501
        """Сохранить в память"""
        try:
            # Проверяем размер
            serialized_value = self._serialize_value(value, config)
            ...
            if self.current_memory_usage + size_bytes > self.max_memory_cache_size  # noqa  # noqa: E501 E501
            ...
            logger.error("Error storing in memory: {e}")
    ...
    async def _store_in_redis(self, key: str, value: Any, config: CacheConfig):
        ...
        try:
            ...
            logger.error("Error storing in Redis: {e}")
    ...
    async def _store_in_cdn(self, key: str, value: Any, config: CacheConfig):
        ...
        try:
            ...
            logger.info("Storing {key} in CDN (simulated)")
        except Exception as e:
            logger.error("Error storing in CDN: {e}")
    ...
    async def _get_from_redis(self, key: str) -> Any:
        ...
        try:
            ...
            logger.error("Error getting from Redis: {e}")
            return None
    ...
    async def _get_from_cdn(self, key: str) -> Any:
        ...
        try:
            ...
            logger.error("Error getting from CDN: {e}")
            return None
    ...
    async def _delete_from_cdn(self, key: str):
        ...
        try:
            ...
            logger.info("Deleting {key} from CDN (simulated)")
        except Exception as e:
            logger.error("Error deleting from CDN: {e}")
    ...
    def _serialize_value(self, value: Any, config: CacheConfig) -> Any:
        ...
        try:
            if config.compress and len(str(value).encode('utf-8')) > self.compression_threshold  # noqa  # noqa: E501 E501
    ...
    def _deserialize_value(self, value: Any, config: Optional[CacheConfig]) -> Any  # noqa  # noqa: E501 E501
    ...
    async def _evict_from_memory(self):
        ...
        try:
            ...
            logger.error("Error evicting from memory: {e}")
    ...
    async def _cleanup_expired_entries(self):
        ...
        while True:
            try:
                ...
                if expired_keys:
                    logger.info("Cleaned up {len(expired_keys)} expired cache entries")
    ...
    async def _memory_usage_monitor(self):
        ...
        while True:
            try:
                ...
                if usage_percent > 80:
                    logger.warning("Memory cache usage is {usage_percent:.1f}% ({usage_mb:.1f}MB/{max_mb  # noqa  # noqa: E501 E501.1f}MB)")
                    await self._evict_from_memory()

            except Exception as e:
                logger.error("Error in memory monitor: {e}")
    ...
    async def warm_up_cache(self, warm_up_functions: List[Callable]) -> Dict[str, Any]  # noqa  # noqa: E501 E501
        """Прогрев кэша"""
        try:
            results = {
                "warmed_up": 0,
            ...
            for func in warm_up_functions:
                try:
                    ...
                    logger.error("Error warming up cache with {func.__name__}: {e}")
